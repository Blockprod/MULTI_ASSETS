...
### P2-NAMING — Dual naming USDT/USDC (par design, aucune action)
...
**Baseline :** Bot LIVE depuis 10:01:34 — position ouverte (809.2 ONDO @ 0.2641)
...
| D-11 | **P3** | ⏳ INVESTIGATION | Backtest USDT vs trading USDC | Légère divergence de prix possible |
...
### D-11 · Backtest USDT vs trading USDC

**Constat :**
Les backtests téléchargent les données USDT (1h, 4h, 1d), le trading réel se fait sur USDC. Les prix peuvent légèrement diverger entre les deux paires.

**Action :** ✅ CLÔTURÉ — dual naming par design
UST (backtest) / USDC (live) : architecture intentionnelle. L'écart de prix USDT/USDC est < 0.01%, négligeable. Pas de migration des backtests requise.
