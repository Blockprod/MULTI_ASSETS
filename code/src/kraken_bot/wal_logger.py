...
Format fichier : JSONL append-only, une opération par ligne.
  {"ts": 1713109680, "op": "BUY_INTENT",    "pair": "ONDOUSD", "qty_str": "0.001", ...}
  {"ts": 1713109682, "op": "BUY_CONFIRMED", "pair": "ONDOUSD", "order_id": "abc123"}
  {"ts": 1713109684, "op": "SL_PLACED",     "pair": "ONDOUSD", "sl_order_id": "def456"}
...
def wal_replay() -> List[str]:
    ...
    Returns :
      Liste de paires (ex. ["XRPUSDC", "ONDOUSD"]) à réconcilier immédiatement.
