...
def get_optimal_ema_periods(df: pd.DataFrame, timeframe: str = '4h', symbol: str = 'SOLUSDC') -> tuple:
    """
...
def get_binance_trading_fees(client, symbol='SOLUSDC'):
    """
...
def check_partial_exits_from_history(real_trading_pair: str, entry_price: float) -> Tuple[bool, bool]:
    ...
    Args:
        real_trading_pair: Symbole de la paire (ex: SOLUSDC)
